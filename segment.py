...
def segment_image(frame, display=False, render=False, output_path=None):
...
if __name__ == "__main__":
    ...
    segmenter = TableSegmenter.load_from_checkpoint(model_path, loss="DICE")
